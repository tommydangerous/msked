...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Employee.tier_office'
        db.alter_column('employees_employee', 'tier_office', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Employee.tier_office'
        db.alter_column('employees_employee', 'tier_office', self.gf('django.db.models.fields.IntegerField')(default=''))
