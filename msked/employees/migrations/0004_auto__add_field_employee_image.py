...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('employees_employee', 'image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('employees_employee', 'image')


    models = {
        'employees.employee': {
            'Meta': {'ordering': "('last_name', 'first_name')", 'unique_together': "(('first_name', 'last_name'),)", 'object_name': 'Employee'},
