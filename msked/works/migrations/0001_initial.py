...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Work', fields ['employee', 'job']
        db.create_unique('works_work', ['employee_id', 'job_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Work', fields ['employee', 'job']
        db.delete_unique('works_work', ['employee_id', 'job_id'])
    ...
    models = {
        ...
        'works.work': {
            'Meta': {'unique_together': "(('employee', 'job'),)", 'object_name': 'Work'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
