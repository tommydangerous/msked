...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Note.station'
        db.add_column('notes_note', 'station',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stations.Station'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Note.employee'
        db.alter_column('notes_note', 'employee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Employee'], null=True))

    def backwards(self, orm):
        # Deleting field 'Note.station'
        db.delete_column('notes_note', 'station_id')


        # Changing field 'Note.employee'
        db.alter_column('notes_note', 'employee_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['employees.Employee']))
    ...
    models = {
        ...
        'notes.note': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'employee': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['employees.Employee']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'station': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['stations.Station']", 'null': 'True', 'blank': 'True'}),
