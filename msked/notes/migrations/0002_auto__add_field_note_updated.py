...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Note.updated'
        db.add_column('notes_note', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 16, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Note.updated'
        db.delete_column('notes_note', 'updated')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 16, 0, 0)'}),
