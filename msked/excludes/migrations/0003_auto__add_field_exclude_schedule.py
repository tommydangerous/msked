...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exclude.schedule'
        db.add_column('excludes_exclude', 'schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedules.Schedule'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exclude.schedule'
        db.delete_column('excludes_exclude', 'schedule_id')
    ...
    models = {
        ...
        'excludes.exclude': {
            ...
            'schedule': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schedules.Schedule']", 'null': 'True', 'blank': 'True'}),
