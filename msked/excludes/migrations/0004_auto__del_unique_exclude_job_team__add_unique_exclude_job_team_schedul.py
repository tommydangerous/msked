...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Exclude', fields ['job', 'team', 'schedule']
        db.create_unique('excludes_exclude', ['job_id', 'team_id', 'schedule_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Exclude', fields ['job', 'team', 'schedule']
        db.delete_unique('excludes_exclude', ['job_id', 'team_id', 'schedule_id'])
    ...
    models = {
        ...
        'excludes.exclude': {
            'Meta': {'unique_together': "(('job', 'schedule', 'team'),)", 'object_name': 'Exclude'},
